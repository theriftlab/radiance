...
test('add', function () {
    ...
    expect(fn () => $this->longitude->add(150))->toThrow(LongitudeBoundaryError::class);
});
...
test('sub', function () {
    ...
    expect(fn () => $this->negativeLongitude->sub(150))->toThrow(LongitudeBoundaryError::class);
});
...
test('distanceTo', function () {
    ...
    expect(fn () => $this->longitude->distanceTo(181))->toThrow(LongitudeBoundaryError::class);
});
...
test('distanceFrom', function () {
    ...
    expect(fn () => $this->longitude->distanceFrom(-181))->toThrow(LongitudeBoundaryError::class);
});
...
test('midpointWith', function () {
    ...
    expect(fn () => Longitude::make(20)->midpointWith(181))->toThrow(LongitudeBoundaryError::class);
});
